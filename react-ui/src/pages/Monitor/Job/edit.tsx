      ...
      <ProForm
        ...
        <ProFormDigit
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入任务编号！" />,
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入任务名称！" />,
            },
          ]}
        />
        <ProFormSelect
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入任务组名！" />,
            },
          ]}
        />
        <ProFormTextArea
          ...
          rules={[
            {
              required: true,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入调用目标字符串！" />,
            },
          ]}
        />
        <ProFormCaptcha
        ...
        <ProFormRadio.Group
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入计划执行错误策略！" />,
            },
          ]}
          fieldProps={{
            optionType: "button",
        ...
        <ProFormRadio.Group
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入是否并发执行！" />,
            },
          ]}
          fieldProps={{
            optionType: "button",
