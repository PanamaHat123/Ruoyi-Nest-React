      ...
      <ProForm form={form} onFinish={handleFinish}>
          <ProFormText.Password
            ...
            rules={[
              {
                required: true,
                message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入旧密码！" />,
              },
            ]}
          />
          <ProFormText.Password
            ...
            rules={[
              {
                required: true,
                message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入新密码！" />,
              },
            ]}
          />
          <ProFormText.Password
            ...
            rules={[
              {
                required: true,
                message: (
                  <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入确认密码！" />
                ),
              },
