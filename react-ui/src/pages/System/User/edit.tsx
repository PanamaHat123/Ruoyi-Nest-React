...
import { ProForm,ProFormDigit,ProFormText,ProFormDateTimePicker,ProFormRadio, ProFormTreeSelect ,ProFormCheckbox, ProFormTextArea, ProFormSelect } from "@ant-design/pro-form";
...
const UserForm: React.FC<UserFormProps> = (props) => {
  ...
  const handleFinish = async (values: Record<string, any>) => {
    (values as UserFormData).userId = props.values.userId;
      ...
      <ProForm
          ...
          rules={[
            {
              required: true,
              message: (
                <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入用户部门！" />
              ),
            },
          ]}
        />
          ...
          rules={[
            {
              required: false,
              message: (
                <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入用户邮箱！" />
              ),
            },
          ]}
        />
        ...
        <ProFormText.Password
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入密码！" />,
            },
          ]}
        />
        <ProFormSelect
          ...
          rules={[
            {
              required: false,
              message: (
                <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入用户性别！" />
              ),
            },
          ]}
        />
          ...
          rules={[
            {
              required: false,
              message: (
                <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入帐号状态！" />
              ),
            },
          ]}
        />
