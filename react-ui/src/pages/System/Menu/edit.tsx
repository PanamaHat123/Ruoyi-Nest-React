      ...
      <ProForm
        ...
        <ProFormDigit
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入菜单编号！" />,
            },
          ]}
        />
        <ProFormTreeSelect
          ...
          rules={[
            {
              required: true,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入父菜单编号！" />,
            },
          ]}
          fieldProps = {{
            defaultValue: 0
        ...
        <ProFormRadio.Group
          ...
          rules={[
            {
              required: true,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入菜单类型！" />,
            },
          ]}
          fieldProps={{
            defaultValue: 'M',
        ...
        <ProFormSelect
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入菜单图标！" />,
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: true,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入菜单名称！" />,
            },
          ]}
        />
        <ProFormDigit
        ...
        <ProFormRadio.Group
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.placeholder.input" defaultMessage="请输入是否为外链！" />,
            },
          ]}
          fieldProps = {{
            defaultValue: '1'
          ...
          rules={[
            {
              ...
              message: <FormattedMessage id="enum.placeholder.input" defaultMessage="请输入路由地址！" />,
            },
          ]}
        />
        <ProFormText
