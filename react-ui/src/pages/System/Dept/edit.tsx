      ...
      <ProForm
        ...
        <ProFormDigit
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入部门id！" />,
            },
          ]}
        />
        <ProFormTreeSelect
          ...
          rules={[
            {
              required: true,
              message: (
                <FormattedMessage id="enum.form.validate.required" defaultMessage="请选择上级部门!" />
              ),
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入部门名称！" />,
            },
          ]}
        />
        <ProFormDigit
        ...
        <ProFormText
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入负责人！" />,
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入联系电话！" />,
            },
          ]}
        />
        <ProFormText
        ...
        <ProFormRadio.Group
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入部门状态！" />,
            },
          ]}
        />
      </ProForm>
