    ...
    >
        ...
        <ProFormDigit
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入参数主键！" />,
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入参数名称！" />,
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入参数键名！" />,
            },
          ]}
        />
        <ProFormTextArea
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入参数键值！" />,
            },
          ]}
        />
        <ProFormRadio.Group
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入系统内置！" />,
            },
          ]}
        />
        <ProFormTextArea
