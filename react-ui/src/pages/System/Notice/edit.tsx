    ...
    >
        ...
        <ProFormDigit
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入公告编号！" />,
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: true,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入公告标题！" />,
            },
          ]}
        />
        <ProFormSelect
          ...
          rules={[
            {
              required: true,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入公告类型！" />,
            },
          ]}
        />
        <ProFormRadio.Group
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入公告状态！" />,
            },
          ]}
        />
        <ProFormTextArea
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入公告内容！" />,
            },
          ]}
        />
        <ProFormText
