    ...
    >
        ...
        <ProFormDigit
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入访问编号！" />,
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入用户账号！" />,
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入登录IP地址！" />,
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入登录地点！" />,
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入浏览器类型！" />,
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入操作系统！" />,
            },
          ]}
        />
        <ProFormRadio.Group
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入登录状态！" />,
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入提示消息！" />,
            },
          ]}
        />
        <ProFormTimePicker
          ...
          rules={[
            {
              required: false,
              message: <FormattedMessage id="enum.form.validate.required" defaultMessage="请输入访问时间！" />,
            },
          ]}
        />
      </ProForm>
